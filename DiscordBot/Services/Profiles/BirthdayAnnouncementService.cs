...
public class BirthdayAnnouncementService
{
    ...
    public BirthdayAnnouncementService(DiscordSocketClient client, ILoggingService loggingService, BotSettings settings, DatabaseService databaseService, CancellationTokenSource cts)
    {
        _client = client;
