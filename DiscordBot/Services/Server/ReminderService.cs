...
public class ReminderService
{
    ...
    {
        global::DiscordBot.Utils.SerializeUtil.SerializeFile($"{_serverRootPath}/reminders.json", _reminders);
    }
    private void LoadReminders()
    {
        _reminders = global::DiscordBot.Utils.SerializeUtil.DeserializeFile<List<ReminderItem>>($"{_serverRootPath}/reminders.json");
    }
